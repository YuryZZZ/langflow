...
For subtask "Test DuckDB MCP tools":
...
{
  "planner": "planner-1",
  "task_description": "Test all DuckDB MCP tools including create_run, push_task, complete_task"
}
```
...
| MCP | Purpose |
|-----|---------|
| duckdb | Task bus - 40 tools |
| parallel | TRUE parallel execution (USE THIS!) |
| memory | Knowledge graph |
| sequential-thinking | Chain-of-thought |
| filesystem | File operations |

## DuckDB Recording (REQUIRED)
1. duckdb.push_task() before dispatching
2. duckdb.complete_task() when workers finish

## Return Format to Orchestrator
{
  "planner": "planner-1",
  "subtask": "Test DuckDB MCP tools",
  "status": "COMPLETED",
